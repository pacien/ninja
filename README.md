...
6.  Copy Ninja app ID from the Chrome Extensions page under the app name.
7. On Windows:
    ...
    Double click on Local Ninja Origin and paste the Ninja app ID copied in step 6 from the Chrome Extensions page in the Value data field. Close Registry Editor.
8. On Mac:
    Launch Finder.
    ...
    For value, paste the Ninja app ID copied in step 6 from the Chrome Extensions page.
